...
def get_features_args():
    ...
    if is_flag_set("FLASH_MLA_DISABLE_SM100"):
        features_args.append("-DFLASH_MLA_DISABLE_SM100_BINDINGS")
    if is_flag_set("FLASH_MLA_DISABLE_SM90_SPARSE_FP8"):
        features_args.append("-DFLASH_MLA_DISABLE_SM90_SPARSE_FP8")
...
def get_nvcc_version():
    ...
    version_number = nvcc_version.split("release ")[1].split(",")[0].strip()
...
if CUDA_HOME is not None:
    nvcc_major, nvcc_minor = get_nvcc_version()
